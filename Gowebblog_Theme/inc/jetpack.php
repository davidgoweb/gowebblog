				...
				<div class="related-post">
					<a href="<?php echo esc_url( get_permalink( $post_id ) ); ?>" class="group block">
						<div class="img-zoom-container rounded-xl overflow-hidden mb-6 aspect-[3/2]">
							...
							<?php else : ?>
								<img src="https://dummyimage.com/600x400/222/fff?text=<?php echo urlencode( get_the_title( $post_id ) ); ?>" alt="<?php echo esc_attr( get_the_title( $post_id ) ); ?>" class="img-zoom w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
							<?php endif; ?>
						</div>

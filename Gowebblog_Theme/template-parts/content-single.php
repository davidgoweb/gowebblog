			...
			<div class="nav-previous">
				<a href="<?php echo esc_url( get_permalink( $prev_post ) ); ?>" class="group flex items-start gap-4 p-6 bg-card/30 rounded-xl border border-white/5 hover:border-white/20 transition-all duration-300">
					<div class="w-16 h-16 rounded-lg overflow-hidden flex-shrink-0">
						...
						<?php else : ?>
							<img src="https://dummyimage.com/80x80/333/fff?text=<?php echo urlencode( $prev_post->post_title ); ?>" alt="<?php echo esc_attr( $prev_post->post_title ); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300">
						<?php endif; ?>
					</div>
					<div>
			...
			<div class="nav-next">
				<a href="<?php echo esc_url( get_permalink( $next_post ) ); ?>" class="group flex items-start gap-4 p-6 bg-card/30 rounded-xl border border-white/5 hover:border-white/20 transition-all duration-300">
					<div class="w-16 h-16 rounded-lg overflow-hidden flex-shrink-0">
						...
						<?php else : ?>
							<img src="https://dummyimage.com/80x80/333/fff?text=<?php echo urlencode( $next_post->post_title ); ?>" alt="<?php echo esc_attr( $next_post->post_title ); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300">
						<?php endif; ?>
					</div>
					<div>

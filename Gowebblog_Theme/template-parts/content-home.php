...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'group fade-in-section' ); ?>>
	<div class="relative overflow-hidden rounded-xl mb-6 aspect-[3/2]">
		...
		<?php else : ?>
			<img src="https://dummyimage.com/600x400/222/fff?text=<?php echo urlencode( get_the_title() ); ?>" alt="<?php the_title_attribute(); ?>" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
		<?php endif; ?>

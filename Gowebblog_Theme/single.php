										...
										<a href="<?php the_permalink(); ?>" class="group block">
											<div class="flex gap-3">
												<div class="w-20 h-20 rounded-lg overflow-hidden flex-shrink-0">
													...
													<?php else : ?>
														<img src="https://dummyimage.com/80x80/333/fff?text=<?php echo esc_attr( get_the_title() ); ?>" alt="<?php the_title_attribute(); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300">
													<?php endif; ?>
												</div>
												<div>
